...
import {
    PRIMARY, GRAY, TEXT, BACKGROUND, BORDER, ERROR, SUCCESS, WARNING, INFO
} from '../../constants/colors';
import {
    FiArrowLeft, FiEdit, FiTrash2, FiAlertTriangle, FiCalendar, FiMapPin,
    FiUser, FiActivity, FiFileText, FiClock, FiCheckCircle, FiTablet, FiBox,
    FiThermometer, FiHeart, FiWind, FiPhone, FiMail, FiCode, FiUserCheck
} from 'react-icons/fi';
...
const HealthEventDetail = () => {
    ...
    const renderMedicationCard = (item, index) => {
        ...
        const isSupply = item.dose === 0 && item.medicalPerOnce === 0;
        ...
        return (
            <div
                ...
                style={{
                    backgroundColor: isMedication ? PRIMARY[25] : WARNING[25],
            ...
            >
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="lg:col-span-3">
                        <div className="flex items-center space-x-3 mb-4">
                            <div
                                ...
                                style={{ backgroundColor: isMedication ? PRIMARY[100] : WARNING[100] }}
                            >
                                {isMedication ? (
                                    <FiTablet className="h-5 w-5" style={{ color: PRIMARY[600] }} />
                                ) : (
                                    <FiBox className="h-5 w-5" style={{ color: WARNING[600] }} />
                                )}
                            </div>
                            <div className="flex items-center space-x-2">
                                ...
                                <span
                                    ...
                                    style={{
                                        backgroundColor: isMedication ? PRIMARY[100] : WARNING[100],
                                        color: isMedication ? PRIMARY[700] : WARNING[700]
                                    }}
                                >
                    ...
                    {renderInfoItem("Số lượng sử dụng", `${item.medicationQuantity || 0}`, null, true, true)}

                    {/* Chỉ hiển thị cho thuốc */}
                    {isMedication && (
                        <>
                            {renderInfoItem("Liều lượng/ngày", `${item.dose || 0}`, null, true, true)}
    ...
    // Phân loại thuốc và vật tư y tế
    ...
    // Sắp xếp: thuốc lên trên, vật tư y tế ở dưới
        ...
        <div className="min-h-screen p-6" style={{ backgroundColor: BACKGROUND.NEUTRAL }}>
            <div className="w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className={STYLES.card.content}>
                            ...
                            <div>
                                <h5 className="text-lg font-semibold mb-6 flex items-center" style={{ color: TEXT.PRIMARY }}>
                                    <FiUser className="inline-block mr-3 h-7 w-7" style={{ color: SUCCESS[500] }} />
                                    Thông tin học sinh
                                </h5>
                            ...
                            {/* Event Information - Middle Section */}
                            <div className=" pb-8 border-b" style={{ borderColor: BORDER.LIGHT }}>
                                <h3 className="text-lg font-semibold mb-6 flex items-center" style={{ color: TEXT.PRIMARY }}>
                                    <FiActivity className="mr-2 h-5 w-5" style={{ color: PRIMARY[500] }} />
                                    Thông tin sự kiện
                                </h3>
                        ...
                        <div className="p-8">
                            {sortedMedicalItems.length === 0 ? (
                                ...
                                <div
                                    ...
                                    style={{
                                        height: '630px',
                                        overflowY: sortedMedicalItems.length > 3 ? 'scroll' : 'hidden'
                                    }}
                                >
                    ...
                    {/* Row 2, Col 1: Action Taken & Outcome */}
                    <div className={STYLES.card.base} style={{ borderColor: BORDER.DEFAULT }}>
                        <div className={STYLES.card.header} style={{ borderColor: BORDER.LIGHT, backgroundColor: PRIMARY[50] }}>
                        ...
                        <div className={STYLES.card.content}>
                            <div className="space-y-6">
                                ...
                                {healthEvent.currentHealthStatus && (
                                    <div className="border-t" style={{ borderColor: BORDER.LIGHT }}>
                                        <div className="flex items-center mb-6">
                                            <div className="p-2 rounded-lg mr-3" style={{ backgroundColor: PRIMARY[50] }}>
                                                <FiHeart className="h-5 w-5" style={{ color: PRIMARY[500] }} />
                                            </div>
