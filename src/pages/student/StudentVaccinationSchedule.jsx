...
const StudentVaccinationSchedule = () => {
    const { user } = useAuth();
    ...
    const fetchVaccinationSessions = async () => {
        ...
        try {
            ...
            const response = await vaccinationScheduleApi.getStudentVaccinationSessions(user.id, { pageIndex: 1, pageSize: 100 });
            if (response.success) {
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: BACKGROUND.NEUTRAL }}>
                <Loading type="medical" size="large" color="primary" text="Đang tải lịch tiêm chủng..." />
            </div>
        );
    }
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center text-white max-w-5xl mx-auto">
                        ...
                        <p className="text-base sm:text-lg opacity-90 leading-relaxed font-medium px-4">
                            Quản lý lịch tiêm chủng của bạn
                        </p>
                    </div>
                </div>
            </section>
                                            ...
                                            <td className="py-4 px-6 w-1/4">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-sm mt-1" style={{ color: TEXT.SECONDARY }}>
                                                        {user?.name} • Lớp {user?.currentClassName || 'N/A'}
                                                    </span>
                                                </div>
                                            </td>
...
export default StudentVaccinationSchedule;
